    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="custom-file col-sm-7" style="margin-bottom: 25px;">
                ...
                <?php foreach ($user as $u) { ?>
                    <div class="form-group form-check">
                        <input type="radio" class="form-check-input" id="exampleCheck1" value="<?= $u["type_id"]; ?>" name="type">
                        <label class="form-check-label" for="exampleCheck1"><?= $u["nama"]; ?></label>
                    </div>
                <?php } ?>
